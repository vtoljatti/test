<template>
    <div>
        <b-modal ref="newSellerModal" size="lg" hide-footer hide-header>

            <b-row>
                <b-col class="text-left pb-1">
                    <span class="h5 p-0 m-0 text-muted font-weight-normal">
                        {{ id ? 'Редактирование' : 'Новый продавец' }}
                    </span>
                </b-col>
                <b-col class="text-right justify-content-top">
                    <button @click="hideSellerModal" class="btn btn-white text-muted font-weight-normal">
